...
logging.basicConfig(level=logging.DEBUG, filename='fundamental_stock/yh_get_all_symbols/yh_get_all_sym.log', 
...
def main():
    ...
    f=open("fundamental_stock/yh_all_symbols/yh_all_symbols.txt","w",encoding='UTF-8')
